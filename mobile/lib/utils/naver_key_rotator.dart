...
class NaverSearchKeyRotator {
  ...
  final List<_KeyPair> _keys = [
    _KeyPair(AppConfig.naverAppSearchClientId1, AppConfig.naverAppSearchClientSecret1),
    _KeyPair(AppConfig.naverAppSearchClientId2, AppConfig.naverAppSearchClientSecret2),
    _KeyPair(AppConfig.naverAppSearchClientId3, AppConfig.naverAppSearchClientSecret3),
    _KeyPair(AppConfig.naverAppSearchClientId4, AppConfig.naverAppSearchClientSecret4),
    _KeyPair(AppConfig.naverAppSearchClientId5, AppConfig.naverAppSearchClientSecret5),
    _KeyPair(AppConfig.naverAppSearchClientId6, AppConfig.naverAppSearchClientSecret6),
    _KeyPair(AppConfig.naverAppSearchClientId7, AppConfig.naverAppSearchClientSecret7),
    _KeyPair(AppConfig.naverAppSearchClientId8, AppConfig.naverAppSearchClientSecret8),
    _KeyPair(AppConfig.naverAppSearchClientId9, AppConfig.naverAppSearchClientSecret9),
    _KeyPair(AppConfig.naverAppSearchClientId10, AppConfig.naverAppSearchClientSecret10),
    _KeyPair(AppConfig.naverAppSearchClientId11, AppConfig.naverAppSearchClientSecret11),
    _KeyPair(AppConfig.naverAppSearchClientId12, AppConfig.naverAppSearchClientSecret12),
    _KeyPair(AppConfig.naverAppSearchClientId13, AppConfig.naverAppSearchClientSecret13),
    _KeyPair(AppConfig.naverAppSearchClientId14, AppConfig.naverAppSearchClientSecret14),
    _KeyPair(AppConfig.naverAppSearchClientId15, AppConfig.naverAppSearchClientSecret15),
    _KeyPair(AppConfig.naverAppSearchClientId16, AppConfig.naverAppSearchClientSecret16),
    _KeyPair(AppConfig.naverAppSearchClientId17, AppConfig.naverAppSearchClientSecret17),
  ];
